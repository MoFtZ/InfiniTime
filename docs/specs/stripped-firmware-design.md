...
**On-watch clock setting.** The "Date & Time" setting screen is removed, along with its entry in the settings menu, since the time comes from the phone and a child should not be able to change it. The time-format (12- or 24-hour) menu is likewise removed, and the clock is fixed to a 12-hour display.
